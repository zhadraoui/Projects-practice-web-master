var BugDispatch = {
  options: {
    ...
    maxWiggleDeg: 5,
    imageSprite:
      "https://s3-us-west-2.amazonaws.com/s.cdpn.io/191814/fly-sprite.png",
    bugWidth: 13,
    bugHeight: 14,
    num_frames: 5,
    ...
    mouseOver: "random", // bugs behaviour can be anything
  },
...
var SpiderController = function () {
  var spiderOptions = {
    imageSprite:
      "https://s3-us-west-2.amazonaws.com/s.cdpn.io/191814/spider-sprite.png",
    bugWidth: 69,
    bugHeight: 90,
    num_frames: 7,
    canFly: false,
...
var Bug = {
  ...
  animate: function (t) {
    ...
    if (delta < 40) return; // don't animate too frequently, it will hand browser
